...
using Net.Qks.Migrations.Seed.Host;
...
namespace Net.Qks.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : QksAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<QksDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(QksConsts.ConnectionStringName).Value.ToString();
        }
