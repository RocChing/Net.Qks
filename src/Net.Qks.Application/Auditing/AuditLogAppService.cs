...
using Net.Qks.Auditing.Exporting;
using Net.Qks.Authorization;
using Net.Qks.Authorization.Users;
using Net.Qks.Dto;
using Net.Qks.EntityHistory;
using EntityHistoryHelper = Net.Qks.EntityHistory.EntityHistoryHelper;

namespace Net.Qks.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : QksAppServiceBase, IAuditLogAppService
    {
