...
{
    public class SessionAppService : QksAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = QksConsts.Currency,
                    CurrencySign = QksConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = QksConsts.AllowTenantsToChangeEmailSettings
                }
            };
