...
using Net.Qks.DemoUiComponents.Dto;

namespace Net.Qks.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : QksAppServiceBase, IDemoUiComponentsAppService
    {
