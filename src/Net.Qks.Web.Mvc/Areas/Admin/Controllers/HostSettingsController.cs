...
using Net.Qks.Configuration.Host;
using Net.Qks.Editions;
using Net.Qks.Timing;
using Net.Qks.Timing.Dto;
using Net.Qks.Web.Areas.Admin.Models.HostSettings;
...
namespace Net.Qks.Web.Areas.Admin.Controllers
{
    ...
    public class HostSettingsController : QksControllerBase
    {
