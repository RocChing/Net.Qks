(function () {
    $(function () {
        ...
        var _cachingService = abp.services.qks.caching;
        var _webLogService = abp.services.qks.webLog;
        ...
        function getFormattedLogs(logLines) {
            ...
            $.each(logLines, function (index, logLine) {
                resultHtml += '<span class="log-line">' + _.escape(logLine)
                    .replace('DEBUG', '<span class="kt-badge kt-badge--inline kt-badge--dark">DEBUG</span>')
                    .replace('INFO', '<span class="kt-badge kt-badge--inline kt-badge--info">INFO</span>')
                    .replace('WARN', '<span class="kt-badge kt-badge--inline kt-badge--warning">WARN</span>')
                    .replace('ERROR', '<span class="kt-badge kt-badge--inline kt-badge--danger">ERROR</span>')
                    .replace('FATAL', '<span class="kt-badge kt-badge--inline kt-badge--danger">FATAL</span>') + '</span>';
            });
            return resultHtml;
        }
