(function () {
    $(function () {
        ...
        var _paymentService = abp.services.qks.payment;
        var _invoiceService = abp.services.qks.invoice;
        var _subscriptionService = abp.services.qks.subscription;
        ...
        $('#btnDisableRecurringPayments').click(function () {
            ...
            _subscriptionService.disableRecurringPayments({}).done(function () {
                abp.ui.clearBusy();
                $('#btnEnableRecurringPayments').closest("div.m-form__group").removeClass("d-none");
                $('#btnDisableRecurringPayments').closest("div.m-form__group").addClass("d-none");
                if ($('#btnExtend')) {
        ...
        $('#btnEnableRecurringPayments').click(function () {
            ...
            _subscriptionService.enableRecurringPayments({}).done(function () {
                abp.ui.clearBusy();
                $('#btnDisableRecurringPayments').closest("div.m-form__group").removeClass("d-none");
                $('#btnEnableRecurringPayments').closest("div.m-form__group").addClass("d-none");
        ...
        function createOrShowInvoice(data) {
            ...
            if (invoiceNo) {
                window.open('/Admin/Invoice?paymentId=' + paymentId, '_blank');
            } else {
