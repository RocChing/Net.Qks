(function () {
    $(function () {
        ...
        var _editionService = abp.services.qks.edition;
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/Editions/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Editions/_CreateModal.js',
            modalClass: 'CreateOrEditEditionModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/Editions/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Editions/_EditModal.js',
            modalClass: 'CreateOrEditEditionModal'
        });

        var _moveTenantsToAnotherEditionModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/Editions/MoveTenantsToAnotherEdition',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
