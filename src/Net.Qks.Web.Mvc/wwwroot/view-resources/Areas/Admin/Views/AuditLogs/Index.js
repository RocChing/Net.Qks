            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (exception) {
                        ...
                        if (exception) {
                            $div.append($("<i/>").addClass("fa fa-exclamation-triangle kt-font-warning").attr("title", app.localize("HasError")));
                        } else {
                            $div.append($("<i/>").addClass("fa fa-check-circle kt-font-success").attr("title", app.localize("Success")));
                        }
