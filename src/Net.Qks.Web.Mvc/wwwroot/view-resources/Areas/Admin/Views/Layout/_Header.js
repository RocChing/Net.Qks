(function ($) {
    $(function () {
        ...
        var mySettingsModal = new app.ModalManager({
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Profile/_MySettingsModal.js',
        ...
        $('#UserDownloadCollectedDataLink').click(function (e) {
            e.preventDefault();
            abp.services.qks.profile.prepareCollectedData().done(function () {
        ...
        var changePasswordModal = new app.ModalManager({
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Profile/_ChangePasswordModal.js',
        ...
        var changeProfilePictureModal = new app.ModalManager({
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Profile/_ChangePictureModal.js',
        ...
        var userLoginAttemptsModal = new app.ModalManager({
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Users/_LoginAttemptsModal.js',
        ...
        var _userLinkService = abp.services.qks.userLink;

        var manageLinkedAccountsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/Profile/LinkedAccountsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Profile/_LinkedAccountsModal.js',
        ...
        var _notificationService = abp.services.qks.notification;
