...
using Net.Qks.ApiClient;
using Net.Qks.Controls;
using Net.Qks.Dto;
using Net.Qks.Extensions;
using Net.Qks.Localization;
using Net.Qks.UI;
using Net.Qks.UI.Assets;
using Net.Qks.Views;
using DependencyResolver = Net.Qks.Core.Dependency.DependencyResolver;
...
namespace Net.Qks.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Qks";
