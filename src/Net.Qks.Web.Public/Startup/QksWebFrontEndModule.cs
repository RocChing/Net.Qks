...
namespace Net.Qks.Web.Public.Startup
{
    [DependsOn(
        typeof(QksWebCoreModule)
    )]
    public class QksWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public QksWebFrontEndModule(IHostingEnvironment env, QksEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(QksWebFrontEndModule).GetAssembly());
        }
    }
}
