...
using Net.Qks.Web.Common;
using PaulMiami.AspNetCore.Mvc.Recaptcha;
using Swashbuckle.AspNetCore.Swagger;
using Net.Qks.Web.IdentityServer;
using Net.Qks.Web.Swagger;
using Stripe;
...
using Net.Qks.Schemas;
using Net.Qks.Web.HealthCheck;
...
namespace Net.Qks.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<QksWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env/*, ILoggerFactory loggerFactory*/)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Qks API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Net.Qks.Web.wwwroot.swagger.ui.index.html");
