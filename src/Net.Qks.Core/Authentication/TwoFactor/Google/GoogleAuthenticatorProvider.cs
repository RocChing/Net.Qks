...
namespace Net.Qks.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : QksServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Net.Qks", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
