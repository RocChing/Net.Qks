...
using Net.Qks.Core.Base;
using Net.Qks.Core.Extensions;
using Net.Qks.Dto;
using Net.Qks.Types;

namespace Net.Qks.Queries
{
    public class OrganizationUnitQuery : QksQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
