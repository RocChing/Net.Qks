...
using Net.Qks.MultiTenancy.HostDashboard;
...
namespace Net.Qks.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(QksDbContext context, SubscriptionPayment subscriptionPayment)
        {
