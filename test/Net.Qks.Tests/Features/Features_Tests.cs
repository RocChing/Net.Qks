...
using Net.Qks.Features;
using Net.Qks.Test.Base;
using Shouldly;
using Xunit;

namespace Net.Qks.Tests.Features
{
    ...
    public class Features_Tests : AppTestBase
    {
        ...
        public async Task Should_Not_Create_User_More_Than_Allowed_Count()
        {
            ...
            exception.Message.ShouldContain(_localizationManager.GetString(QksConsts.LocalizationSourceName, "MaximumUserCount_Error_Message"));
        }
    }
}
