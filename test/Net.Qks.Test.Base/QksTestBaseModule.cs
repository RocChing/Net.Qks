...
using Net.Qks.Test.Base.DependencyInjection;
using Net.Qks.Test.Base.UiCustomization;
using Net.Qks.Test.Base.Url;
using Net.Qks.Test.Base.Web;
...
namespace Net.Qks.Test.Base
{
    ...
    public class QksTestBaseModule : AbpModule
    {
        public QksTestBaseModule(QksEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.EntityHistory.Selectors.Add("QksEntities", typeof(User), typeof(Tenant));
        }
